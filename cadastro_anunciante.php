...
include_once 'assets/php/cadastro_anunciante_twitter.php';
...
<html lang="pt-br">
<head>
	<title>QISeventos - cadastro de anunciante</title>
	<meta charset="utf-8" />
	...
	<meta property="og:url" content="http://www.qiseventos.com.br/cadastro_anunciante.php">
	...
	<style type="text/css">
	#bg-login{
	background-image: url('assets/img/img-cad_anunciante.jpg');
	width:100%; 
	height: 100%; 
...
<body class="signup-page index-page">
	...
	}else if(!empty($erro) && $erro == "dados_errados"){
	echo "<div style='z-index:9999; position:absolute;' class='alert alert-info'>
		<div class='container-fluid'>
		<div class='alert-icon'>
		<i class='material-icons'>error_outline</i>
		...
		<b>Dados ERRADOS:</b> Verificamos que este e-mail já existe, porém a sua senha ou o e-mail estão errados. Por favor tente novamente ou entre em contato com o suporte.
		</div>
		</div>";
	}
	?>
<div class="wrapper">
<div class="header" id="bg-login">
<div class="container">
<div class="row"> 
<div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3">
<div class="card_l card-signup" id="boxlogin" style="display: none;background-color: #f5f5f5;">
<form class="form" method="POST" action="assets/php/cadastro_sis_anunciante.php">
<div class="header_l header header-primary text-center" style="background:linear-gradient(60deg, #aaaaaa, #777)!important;">
<h4 rel="tooltip" title="Entre com alguma de suas redes sociais" data-html="true" data-placement="top">cadastro de anunciante</h4>
...
<!-- fim header_l -->
<a href="login.php"><p class="text-divider" id="sub-reg">Já possui uma conta de anunciante?</p></a>
<div class="content">
...
<div class="container">
	...
	&copy; 2018, Feito pela <a href="http://www.troiatecnologia.com.br" target="_blank">Troia Tecnologia</a>
	</div>
</div>
<!-- fim container -->
</footer>
