...
// var except = document.getElementById('vai');
document.body.addEventListener("click", function () {

    var cont = document.getElementsByClassName('navbar-collapse')[0];
    var men = document.getElementsByClassName('navbar-toggle')[0];
	men.addEventListener("click", verifymvisible, false);

	function verifymvisible(){
