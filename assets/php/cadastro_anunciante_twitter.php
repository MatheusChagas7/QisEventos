...
define('CONSUMER_KEY', 'MA0KnVJa0qCDQRDLxkzUcABsL');
define('CONSUMER_SECRET', 'x27qt50ZichLq8gZdRYR54Rp9qv8BJDf68bjZgSDuCNcvRidCG');
define('OAUTH_CALLBACK', 'https://qiseventos.com.br/cadastro_anunciante.php');
// start the session
session_start();
