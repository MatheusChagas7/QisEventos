...
case $lvl == 2:
	echo "
	    	...
	    	<li>
				...
				<li>
				<a id='btn-menu' href='index.php#buscar' class='btn btn-primary btn-lg' style='margin-right: 0px; margin-left: 0px; padding-left: 15px; padding-right: 15px;'>
...
default:
	echo "
	    	<ul class='nav navbar-nav navbar-right'>
				...
				<li>
				<a href='login.php' class='btn btn-primary btn-lg' id='btn-menu' style='margin-right: 0px; margin-left: 0px; padding-left: 15px; padding-right: 15px;'>
    				ANUNCIAR
    			</a>
				</li>
	    	</ul>
