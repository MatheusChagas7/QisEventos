...
if ($con) {
	...
	$query = mysqli_query($con, "DELETE FROM favoritos WHERE id_fk_usu='$id_fav' AND id_fk_cliente='$id_usu'");
}else{
	// erro no banco
	...
	$subject = "[QIS] REMOVER FAVORITO";
	$mensagem1  = "Mensagem enviado pelo site da QISeventos em : SCRIPT DE DESFAVORITAR<br />
	ERRO: {$erro}";
